...
<dependency>
  ...
  <artifactId>petstore-aws-java-client</artifactId>
...
```groovy
compile "org.openapitools:petstore-aws-java-client:1.0.0"
```
...
* `target/petstore-aws-java-client-1.0.0.jar`
* `target/lib/*.jar`

...
public class PetApi {
     ...
     */
    private com.amazonaws.Response addPetCall() throws ApiException {
     ...
     */
    private com.amazonaws.Response deletePetCall() throws ApiException {
        // create path and map variables
     ...
     */
    private com.amazonaws.Response findPetsByStatusCall() throws ApiException {
        // create path and map variables
     ...
     */
    @Deprecated
    private com.amazonaws.Response findPetsByTagsCall() throws ApiException {
        // create path and map variables
     ...
     */
    private com.amazonaws.Response getPetByIdCall() throws ApiException {
        // create path and map variables
        String localVarPath = "/pet/{petId}"
            .replaceAll("\\{" + "petId" + "\\}", localVarApiClient.escapeString(petId.toString()));
        localVarApiClient.setPath(localVarPath);
     ...
     */
    private com.amazonaws.Response updatePetCall() throws ApiException {
        // create path and map variables
        String localVarPath = "/pet";
        localVarApiClient.setPath(localVarPath);
     ...
     */
    private com.amazonaws.Response updatePetWithFormCall() throws ApiException {
        // create path and map variables
        String localVarPath = "/pet/{petId}"
            .replaceAll("\\{" + "petId" + "\\}", localVarApiClient.escapeString(petId.toString()));
        localVarApiClient.setPath(localVarPath);
     ...
     */
    private com.amazonaws.Response uploadFileCall() throws ApiException {
        // create path and map variables
     ...
     */
    private com.amazonaws.Response uploadFileWithRequiredFileCall() throws ApiException {
        // create path and map variables
    ...
    public com.amazonaws.Response uploadFileWithRequiredFile(Long petId, File requiredFile, String additionalMetadata) throws ApiException {
        return uploadFileWithRequiredFileCall();
    }
